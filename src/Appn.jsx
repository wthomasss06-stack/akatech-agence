        ...
        <div className="about-grid">
          ...
          <motion.div initial={{ opacity:0, x:30 }} animate={inView ? { opacity:1, x:0 } : {}} transition={{ duration:.7, ease:[.22,1,.36,1] }}>
            ...
            <p style={{ fontSize:'.92rem', color:'rgba(255,255,255,.5)', lineHeight:1.85, marginBottom:'.9rem' }}>
              Je suis <strong style={{ color:'rgba(255,255,255,.8)' }}>M'Bollo Aka Elvis</strong>, développeur full-stack basé à Abidjan, Côte d'Ivoire. Je conçois des solutions web modernes, performantes et sur mesure pour les entrepreneurs, PME et créatifs africains.
            </p>
            <p style={{ fontSize:'.92rem', color:'rgba(255,255,255,.45)', lineHeight:1.85, marginBottom:'2rem' }}>
              Mon approche : comprendre votre métier avant d'écrire la première ligne de code. Chaque projet est unique — pas de template, pas de copier-coller. Seulement du travail pensé pour <em style={{ color:'#66ffaa' }}>votre</em> réussite.
            </p>
            ...
            <motion.div initial={{ opacity:0, y:12 }} animate={inView ? { opacity:1, y:0 } : {}} transition={{ delay:.9 }}
              ...
              <div style={{ width:46, height:46, borderRadius:'50%', background:'linear-gradient(135deg,rgba(34,200,100,.2),rgba(34,200,100,.06))', border:'2px solid rgba(34,200,100,.25)', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
                <User size={20} style={{ color:'#22c864' }}/>
              </div>
              <div>
              ...
              <a href="https://wa.me/2250142507750?text=Bonjour+AKATech+!" target="_blank" rel="noreferrer"
                className="btn-raised" style={{ marginLeft:'auto', padding:'.6rem 1.1rem', fontSize:'.78rem', flexShrink:0 }}>
                Me contacter
              </a>
            </motion.div>
          </motion.div>
    ...
    <section id="services" ref={ref} style={{padding:'7rem 5%',background:'var(--dark2)',position:'relative'}}>
      ...
      <div style={{maxWidth:1200,margin:'0 auto',position:'relative',zIndex:1}}>
        <motion.div initial={{opacity:0,y:20}} animate={inView?{opacity:1,y:0}:{}} transition={{duration:.6}} style={{textAlign:'center',marginBottom:'4rem'}}>
          <div className="s-eye" style={{justifyContent:'center'}}>// Our Services</div>
          <h2 style={{fontSize:'clamp(1.9rem,3.5vw,2.8rem)',fontWeight:800,fontFamily:"'Syne',sans-serif",letterSpacing:'-.03em',lineHeight:1.15,color:'#fff'}}>
            ...
            <span className="text-gradient-anim">Elevate Your Business</span>
          </h2>
        </motion.div>
        <ServicesBanner/>
...
// ── PROCESS ──────────────────────────────────────────────────
const STEPS=[
  {icon:MessageSquare,n:'01',title:'Consultation',desc:'Échange sur votre projet, besoins et objectifs. Devis gratuit et sans engagement.'},
  {icon:Target,n:'02',title:'Stratégie',desc:'Planification de la solution technique la plus adaptée à votre activité et budget.'},
  {icon:Code,n:'03',title:'Développement',desc:'Création de votre solution web avec les meilleures technologies du secteur.'},
  {icon:Rocket,n:'04',title:'Livraison',desc:'Mise en ligne, formation et support. Votre projet lancé dans les délais convenus.'},
]
    ...
    <section id="process" ref={ref} style={{padding:'7rem 5%',background:'var(--dark1)',position:'relative'}}>
      ...
      <div style={{maxWidth:1200,margin:'0 auto',position:'relative',zIndex:1}}>
        <motion.div initial={{opacity:0,y:20}} animate={inView?{opacity:1,y:0}:{}} style={{textAlign:'center',marginBottom:'4rem'}}>
          <div className="s-eye" style={{justifyContent:'center'}}>// Process</div>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(230px,1fr))',gap:'1.2rem',position:'relative'}}>
          {/* connector */}
          <div className="hidden lg:block proc-connector" style={{position:'absolute',top:48,left:'12.5%',right:'12.5%',height:1,background:'linear-gradient(90deg,transparent,rgba(34,200,100,.2) 20%,rgba(34,200,100,.2) 80%,transparent)',zIndex:0,pointerEvents:'none'}}/>
          {STEPS.map(({icon:Icon,n,title,desc},i)=>(
            <motion.div key={n} initial={{opacity:0,y:28}} animate={inView?{opacity:1,y:0}:{}} transition={{delay:i*.13,ease:[.22,1,.36,1]}} style={{display:'flex',flexDirection:'column',alignItems:'center',textAlign:'center',position:'relative',zIndex:1}}>
              <motion.div whileHover={{scale:1.12,boxShadow:'10px 10px 28px #010402,-4px -4px 18px rgba(34,200,100,.15),0 0 36px rgba(34,200,100,.3)'}} transition={{type:'spring',stiffness:280,damping:18}} className="sku-card" style={{
                ...
                <Icon size={28} style={{color:'#22c864'}}/>
                <div style={{position:'absolute',bottom:-4,right:-4,width:24,height:24,borderRadius:'50%',background:'linear-gradient(145deg,#27d570,#1aa355)',display:'flex',alignItems:'center',justifyContent:'center',boxShadow:'2px 2px 6px rgba(0,0,0,.5)'}}>
                  <span style={{fontFamily:"'JetBrains Mono',monospace",fontSize:'.55rem',fontWeight:700,color:'#fff'}}>{n.slice(-2)}</span>
                </div>
              </motion.div>
              <h3 style={{fontSize:'1rem',fontWeight:700,color:'#fff',fontFamily:"'Syne',sans-serif",marginBottom:'.5rem'}}>{title}</h3>
